    ...
    <aside>
        <div class="header-logo">
            ...
            <a href="/" class="home-link">
                <img src="build/img/CRM-logo_small.png" alt="">
                LP-CRM
            </a>
        </div>
        ...
        <nav class="main-menu">
            <ul class="menu-list">
                <li class="no-submenu" title="Рабочий стол">
                    <span>
                ...
                <li class="active" title="Заказы">
                    <span>
                        <i class="far fa-money-bill-alt"></i>
                        Заказы <b class="count-info">2</b>
                    </span>
                    <ul>
                        <li class="min-menu-title no-hover">Заказы</li>

                        <li title="Статусы заказов"><a href="#">Статусы заказов </a></li>
                        <li title="Способы оплаты"><a href="#">Способы оплаты </a></li>
                        <li class="active" title="Перечень заказов"><a href="#">Перечень заказов <span
                                class="count-info">2</span></a>
                        </li>
                ...
                <li title="Отправка товара">
                    ...
                    <ul>
                        ...
                        <li title="Список для курьера"><a href="#">Список для курьера </a></li>
                ...
                <li title="Склад">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Склад</li>
                ...
                <li title="Шаблоны">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Шаблоны</li>
                ...
                <li title="Модули">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Модули</li>
                ...
                <li title="Статистика">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Статистика</li>
                ...
                <li title="Рассылка">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Рассылка</li>
                ...
                <li title="Настройки">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Настройки</li>
                ...
                <li title="Корзина">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">Корзина</li>
                ...
                <li title="FAQ">
                    ...
                    <ul>
                        <li class="min-menu-title no-hover">FAQ</li>
                ...
                <li class="sidebar-img-block green-info" title="CPashka.biz">
                    <span>
                    <i class="fas fa-star"></i>
                    CPashka.biz
                    </span>
                    <ul>
                        <li class="min-menu-title no-hover">CPashka.biz</li>

                        <li class="no-hover">
                            <img src="build/img/banner_cpashka_side.jpg">
                        </li>
                    </ul>
                </li>


                <li class="sidebar-img-block yellow-info" title="Pokupayko.com">
                    <span>
                    <i class="far fa-smile"></i>
                    Pokupayko.com
                    </span>
                    <ul>
                        <li class="min-menu-title no-hover">Pokupayko.com</li>

                        <li class="no-hover">
                            <a href="https://pokupayko.com/?utm_source=lpcrm&amp;utm_medium=banner" target="_blank">
                                <img src="build/img/pokupayko_banner.jpg">
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <header>
            <div class="header-info">
                <div class="header-tariff">
                    ...
                    <div class="ui popup tariff-popup flowing bottom left transition hidden">
            ...
            <div class="header-controls">
                <div class="user-controls control-block ui">
                    <i class="fas fa-user-circle"></i>
                    <span>Администратор</span>
                </div>

                <div class="ui popup header-user-info flowing transition hidden">
                    <table align="center" border="0">
                        ...
                        <tr>
                            ...
                            <td rowspan="3" align="center" valign="top">
                                ...
                                <div id="image-box"
                                     style="background-image: url(build/img/empty_avatar_40x40.png);"></div>
                            </td>
                        </tr>
                        <tr>
                            <td>Группа</td>
                        ...
                        <tr>
                            <td>Направл.</td>
                            <td>&nbsp;<img src="build/img/flags/UA.ico"
                        ...
                        <tr>
                            <td>Браузер</td>
                            <td colspan="2"><img class="img-icon-browser"
                                                 src="build/img/icons/browser/chrome.ico"
                        ...
                        <tr>
                            <td>IP-адрес</td>
                            <td colspan="2"> &nbsp;178.213.0.225<img class="img-ip-country" title="Украина"
                                                                     src="build/img/flags/UA.ico">
                                Украина
                            </td>
                        </tr>
                        <tr>
                            <td>Язык интерф.</td>
                            <td colspan="2"> &nbsp;<img src="build/img/flags/RU.ico"
                        ...
                        <tr>
                            <td colspan="3" class="user-info-settings"><a href="#"><i
                                    class="fas fa-cog"></i> Настройки</a></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="user-info-logout"><a href="#"><i
                                    class="fas fa-power-off"></i> Выйти</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="control-block">
                    <a href="#" class="icon link ui" data-content="Техподдержка" data-position="bottom center">
                        <i class="fas fa-headphones-alt"></i>
                    </a>
                </div>

                <div class="control-block">
                    <a href="#" class="icon link ui" data-content="Новые заказы" data-position="bottom center">
                        <i class="fas fa-shopping-cart"></i>

                        <span class="control-count">2</span>
                    </a>
                </div>

                <div class="control-block">
                    <a href="#" class="icon link ui" data-content="Уведомления" data-position="bottom center">
        ...
        <div class="main-table orders-table">
            <table class=" ui table blue celled">
                ...
                <tr>
                    <td><p>262474</p></td>
                    <td class="order-id">
                        <div class="blink">новый</div>
                    </td>
                    <td><p>Админ</p></td>
                    <td>
                        <p class="flex-block align-items-center">
                            <img src="build/img/UA.ico" alt=""> Украина
                        </p>
                    </td>
                    ...
                    <td>
                        <p class="flex-block align-items-center">
                            <img src="build/img/money.ico" alt="">
                            Оплачено
                        </p>
                ...
                <tr class="row-sent">
                    ...
                    <td><p class="flex-block align-items-center"><img src="build/img/operators/kyivstar.ico" alt=""> <a
                ...
                <tr class="row-completed">
                    ...
                    <td>
                        <p class="flex-block align-items-center">
                            <img src="build/img/flags/AE.ico" alt=""> Арабские Эмираты
                        </p>
                    </td>
                    <td><p><i class="ui icon phone"></i> 35287523875</p></td>
                    <td><p><i class="ui icon info"></i> test</p></td>
...
<!--<sript src="build/js/script.js"></sript>-->
</body>
</html>